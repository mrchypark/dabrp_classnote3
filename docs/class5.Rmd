...
#### [[pdf다운로드](https://github.com/mrchypark/dabrp_classnote3/raw/master/Materials/class5.pdf)] [[문의하기](http://pf.kakao.com/_RXANd)] [[피드백하기](https://github.com/mrchypark/dabrp_classnote3/issues/new)]
### 박찬엽
...
[과제 확인](https://github.com/mrchypark/dabrp_classnote3/blob/master/Rscript/assign4.R)
...
if (!requireNamespace("ggfortify")) install.packages("ggfortify")
library(ggfortify)
library(data.table)
