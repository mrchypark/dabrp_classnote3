...
#### [[pdf다운로드](https://github.com/mrchypark/dabrp_classnote3/raw/master/Materials/class2.pdf)] [[문의하기](http://pf.kakao.com/_RXANd)] [[피드백하기](https://github.com/mrchypark/dabrp_classnote3/issues/new)]
### 박찬엽
...
![](https://raw.githubusercontent.com/mrchypark/dabrp_classnote3/master/docs/img/fileio.png)
...
![](https://raw.githubusercontent.com/mrchypark/dabrp_classnote3/master/docs/img/conn.png) 
...
![](https://raw.githubusercontent.com/mrchypark/dabrp_classnote3/master/docs/img/conn2.png) 
...
```{r}
conn <- dbConnect(RSQLite::SQLite(), dbname = "../FolderForClass2/class2.sqlite")
conn
