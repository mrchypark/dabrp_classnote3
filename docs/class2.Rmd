...
library(readr)
chennel<-read_csv("../data/recomen/chennel.csv")
competitor<-read_csv("../data/recomen/competitor.csv")
customer<-read_csv("../data/recomen/customer.csv")
item<-read_csv("../data/recomen/item.csv")
membership<-read_csv("../data/recomen/membership.csv")
tran<-read_csv("../data/recomen/tran.csv")
```
