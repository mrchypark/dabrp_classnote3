...
#### 	Step1. 복사-붙여넣기해도 서식이 깨지지 않는 문서화 방법 익히기
### <https://mrchypark.github.io/dabrp_classnote3/class6>

#### [[pdf다운로드](https://github.com/mrchypark/dabrp_classnote3/raw/master/Materials/class6.pdf)] [[문의하기](http://pf.kakao.com/_RXANd)] [[피드백하기](https://github.com/mrchypark/dabrp_classnote3/issues/new)]
### 박찬엽
...
[과제 확인](https://github.com/mrchypark/dabrp_classnote3/blob/master/Rscript/assign5.R)
...
1. code chunk를 만들고 [수업 5에 과제 1.3](https://mrchypark.github.io/dabrp_classnote3/class5#53)의 코드를 넣어주세요.
...
1. 각 github에 `class6` 이라는 저장소를 만들어주세요.
    - class6 저장소로 프로젝트를 만들어주세요.
    - 수업 5의 과제를 모두 index.rmd 파일로 작성해 주세요.
    ...
    - `https://각자계정.github.io/class6` 위치를 확인해주세요.
